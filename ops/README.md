...
## GitHub 側に schedule を書かないこと

起こす役は1つにする。

8/29 に GitHub の `schedule` が復活し、Cloudflare と二重に起動した。
1回が4時間生きる作りだったため、回が重なって順番待ちになり、
片方が押せなかった記録をもう片方が「まだ出していない」と読んで、
同じ知識投稿を 14:00 と 14:21 に二度出した。

いまは `workflow_dispatch:` だけにしてある。戻さないこと。
