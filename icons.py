...
ICONS = {
    ...
    # ---- ウォッチリスト ----
    # 押す前。輪郭だけ。
    "heart": ('<path d="M12 20.3 4.2 12.7a4.8 4.8 0 0 1 0-6.9 4.8 4.8 0 0 1 6.8 0l1 1 1-1'
              'a4.8 4.8 0 0 1 6.8 0 4.8 4.8 0 0 1 0 6.9Z"/>', "line"),

    # 押したあと。塗りつぶし。
    "heart-on": ('<path d="M12 20.3 4.2 12.7a4.8 4.8 0 0 1 0-6.9 4.8 4.8 0 0 1 6.8 0l1 1 1-1'
                 'a4.8 4.8 0 0 1 6.8 0 4.8 4.8 0 0 1 0 6.9Z" '
                 'fill="currentColor" stroke="none"/>', "solid"),
}
